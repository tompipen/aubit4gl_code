#  INSTALL.sh  -  4gwapps/maildemo quick compilation script
#
...
cat <<'EOF-entry'
	...
	This shell script will compile the demo 4glworks mail reader.
	It assumes that your enviromental variables are correctly set,
	and the previous step has appropriately configured 4gwmail
...
case $ans in
    y|Y)
	4glworks/cbuild 4gwapps/maildemo
	;;
    *)
