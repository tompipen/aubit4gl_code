/*
@(#)File:            $RCSfile: stdouble.c,v $
@(#)Version:         $Revision: 1.1 $
@(#)Last changed:    $Date: 2002-06-21 05:44:01 $
@(#)Purpose:         Implement st_double(), st_double_null() - Compatible with C-ISAM stdbl(), stdblnull()
@(#)Author:          J Leffler
...
#ifndef lint
static const char rcs[] = "@(#)$Id: stdouble.c,v 1.1 2002-06-21 05:44:01 afalout Exp $";
#endif
