 ...
 */
char *Comment::getCommentBuffer(Comment *comment)
{
 ...
 */
int Comment::getCommentDeprecated(Comment *comment)
{
  if ( comment == (Comment *)0)
	  return -1;
 ...
 */
TableUsage *Comment::getCommentTableUsage(Comment *comment,int index)
{
  if ( comment == (Comment *)0)
	  return (TableUsage *)0;
 ...
 */
int Comment::getCommentTableUsageIdx(Comment *comment)
{
  if ( comment == (Comment *)0)
	  return -1;
