...
/** 
 * This is generated by convkw_hash in the file generated/kw.yh
 */
...
%token FROM 1528
%token GOTO 1529
%token HELP_FILE 1530
%token LANG_FILE 1531
%token HELP 1532
%token HIDE 1533
%token HOUR 1534
%token INTO 1535
...
%token TO 1615
%token KWUP 1616
%token FONT_NAME 1617
%token FONT_SIZE 1618
%token PAPER_SIZE_IS_LETTER 1619
%token PAPER_SIZE_IS_LEGAL 1620
%token PAPER_SIZE_IS_A5 1621
%token PAPER_SIZE_IS_A4 1622
%token PAPER_SIZE_IS_LETTER_L 1623
%token PAPER_SIZE_IS_LEGAL_L 1624
%token PAPER_SIZE_IS_A5_L 1625
%token PAPER_SIZE_IS_A4_L 1626
%token FORMHANDLER 1627
%token END_FORMHANDLER 1628
%token BEFORE_EVENT 1629
%token BEFORE_OPEN_FORM 1630
%token AFTER_EVENT 1631
%token BEFORE_CLOSE_FORM 1632
%token BEFORE_ANY 1633
%token AFTER_ANY 1634
%token MENUHANDLER 1635
%token END_MENUHANDLER 1636
%token BEFORE_SHOW_MENU 1637
%token DISABLE_PROGRAM 1638
%token DISABLE_ALL 1639
%token BUTTONS 1640
%token CHECK_MENUITEM 1641
%token DISABLE_FORM 1642
%token DISABLE_MENUITEMS 1643
%token DISABLE 1644
%token ENABLE_FORM 1645
%token ENABLE_MENUITEMS 1646
%token ENABLE 1647
%token KWFIELD 1648
%token ICON 1649
%token MESSAGEBOX 1650
%token TO_DEFAULTS 1651
%token UNCHECK_MENUITEM 1652
%token BEFORE 1653
%token INPUT 1654
%token END 1655
%token INT_TO_ID 1656
%token TIMEOUT 1657
%token OFF 1658
%token WITH_1_DIMENSION 1659
%token WITH_2_DIMENSION 1660
%token WITH_3_DIMENSION 1661
%token TILDE 1662
%token ILIKE 1663
%token FGL_ISDYNARR_ALLOCATED 1664
%token FGL_DYNARR_EXTENTSIZE 1665
/*
=====================================================================
                        Source: 99.reqd
=====================================================================
