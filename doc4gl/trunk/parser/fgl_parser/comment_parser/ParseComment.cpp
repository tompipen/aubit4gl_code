 ...
 */
static void ParseComment::initComment(Comment *comm,int bufferSize)
{
  comm->processIdx        = 0;
  comm->file              = 0;
 ...
 */
Comment *ParseComment::parseComment(char *commentToParse)
{
  //register int i;
 ...
 */
int ParseComment::getCommentChar(void)
{
  int retval;
  if ( *currentChar == '\0' )
    retval = EOF;
 ...
 */
void ParseComment::setReturnComments(char *comments)
{
 ...
 */
void ParseComment::setRevision(char *revision)
{
 ...
 *  @param revision Nº de revisão
 */
void ParseComment::setSince(char *since)
{
 ...
 *  @param revision Nº de revisão
 */
void ParseComment::setSee(char *see)
{
 ...
 */
void ParseComment::setAuthor(char *author)
{
 ...
 *  @param comments Comentários a adicionar
 */
void ParseComment::setTodoComments(char *comments)
{
 ...
 */
void ParseComment::setTable(char *tableId)
{
 ...
 */
void ParseComment::writeTagComment(char *tagComment)
{
  switch (currentTag)
  {
    case TAG_PROCESS:
 ...
 */
void ParseComment::setProcessCode(char *id)
{
 ...
 * @param tagCode Código associado à tag corrente
 */
void ParseComment::writeTagCode(char *tagCode)
{
  switch (currentTag)
  {
    case TAG_PROCESS:
 ...
 */
void ParseComment::writeCommentIdentifier(char *id)
{
  commentLineStarted = 0;
  switch (commentState)
  {
 ...
 */
void ParseComment::setModuleDocument(void)
{
 ...
 */
void ParseComment::startProcess(void)
{
 ...
 */
void ParseComment::startParameter(void)
{
  commentState = TAG_CODE;
 ...
 * sitio certo.
 */
void ParseComment::startReturn(void)
{
  commentState = TAG_COMMENT;
 ...
 */
void ParseComment::startTodo(void)
{
  commentState = TAG_COMMENT;
  currentTag   = TAG_TODO;
 ...
 */
void ParseComment::startTable(void)
{
 ...
 */
void ParseComment::startAuthor(void)
{
  commentState = TAG_COMMENT;
 ...
 */
void ParseComment::startRevision(void)
{
  commentState = TAG_COMMENT;
 ...
 * Mark the fact in the state machine in order to read the source code revision
 */
void ParseComment::startSince(void)
{
  commentState = TAG_COMMENT;
 ...
 * Mark the fact in the state machine in order to read the source code revision
 */
void ParseComment::startSee(void)
{
  commentState = TAG_COMMENT;
  currentTag   = TAG_SEE;
}
 ...
 */
void ParseComment::writeNewLine(void)
{
  commentLineStarted = 1;
}
 ...
 */
void ParseComment::writeOtherComment(char *comm)
{
 ...
 */
void ParseComment::writeSeparator(char *comm)
{
  switch (commentState)
  {
    case IN_COMMENT:
 ...
 */
void ParseComment::markAsDeprecated(void)
{
