...
#  ======================================================================
function   ok_bf_mtab_codmod(Alteracao_ou_Insercao) 
{}
   Define
...
function   ok_bf_mtab_tabname(Alteracao_ou_Insercao) 
{}
   Define
      Alteracao_ou_Insercao char(1)
...
#  ======================================================================
function   ok_af_mtab_codmod(Alteracao_ou_Insercao) 
{}
   Define
      Alteracao_ou_Insercao char(1)
...
function   ok_af_mtab_tabname(Alteracao_ou_Insercao) 
{}
   Define
      Alteracao_ou_Insercao char(1)
...
#  Ja esta.
#  ======================================================================
function 	 ok_bi_mtab(Alteracao_ou_Insercao)
{}
   Define
		Alteracao_ou_Insercao char(1)
...
#  Ja esta
#  ======================================================================
function 	 ok_ai_mtab(Alteracao_ou_Insercao)
{}
   Define
		Alteracao_ou_Insercao char(1)
...
#  ======================================================================
function 	 scr_mtab_removido()
{}
   return
end function

function 	 ok_busca_mtab()
{}
   return true
end function

function 	 ok_seguinte_mtab()
{}
   return true
end function

function 	 ok_anterior_mtab()
{}
   return true
end function

function 	 ok_opcoes_mtab()
{}
   return true
end function

function 	 ok_fim_mtab()
{}
   return true
end function

function 	 ok_lista_mtab()
{}
   return true
end function
...
{}
   ...
   CALL d_campo_drep("codmod","codmod","d_mod_tab",fmt,tp)
   CALL d_campo_drep("tabname","tabname","d_mod_tab",fmt,tp)
   ...
   let ans = d_rep("Listagem de ","d_mod_tab",claus_where,pr_scr_ctl[scr_pointer].order_by)
   call d_end_drep()
