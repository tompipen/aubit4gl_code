...
<%@ page import="pt.despodata.java.ddata.connection.DDataSourcePool" %>
...
<jsp:useBean id="connection" scope="session" class="pt.despodata.java.ddata.connection.DDataSourcePool">
