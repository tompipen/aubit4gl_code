...
MAIN
  ...
  -- INTERVAL YEAR TO YEAR
	...
	-- YEAR TO MONTH
	LET lv_varchar = "0000-00"
	LET lv_iv_ymo = lv_varchar
  ...
  -- INTERVAL MONTH TO MONTH
	...
	-- YEAR TO DAY
	--LET lv_varchar = "0000-00-00"
	--LET lv_iv_yd = lv_varchar
	...
	-- MONTH TO DAY
	--LET lv_varchar = "00-00"
	--LET lv_iv_mod = lv_varchar
	...
	-- DAY TO HOUR 
  LET lv_varchar = "00 00"
  LET lv_iv_dh = lv_varchar
  IF lv_iv_dh != INTERVAL(00 00) DAY TO HOUR THEN
		DISPLAY "Error INTERVAL 00 00"
	  LET exitStatus = 1
	END IF

  LET lv_varchar = "99 23"
  LET lv_iv_dh = lv_varchar
