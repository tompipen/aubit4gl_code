...
MAIN
  ...
  -- INTERVAL YEAR TO YEAR
	...
	-- YEAR TO MONTH
	LET lv_iv_ymo = INTERVAL(0000-00) YEAR TO MONTH
  ...
  -- INTERVAL MONTH TO MONTH
	...
	-- YEAR TO DAY
	--LET lv_iv_yd = INTERVAL(0000-00-00) YEAR TO DAY
	...
	-- MONTH TO DAY
	--LET lv_iv_mod = INTERVAL(00-00) MONTH TO DAY
	...
	-- DAY TO DAY
	LET lv_iv_defdd = INTERVAL(00) DAY TO DAY
	IF lv_iv_defdd != INTERVAL(00) DAY TO DAY THEN
		DISPLAY "Error INTERVAL 00"
	  LET exitStatus = 1
	END IF

	LET lv_iv_defdd = INTERVAL(99) DAY TO DAY
	IF lv_iv_defdd != INTERVAL(99) DAY TO DAY THEN
		DISPLAY "Error INTERVAL 99"
	  LET exitStatus = 1
	END IF

	LET lv_iv_onedd = INTERVAL(0) DAY(1) TO DAY
	IF lv_iv_onedd != INTERVAL(0) DAY(1) TO DAY THEN
		DISPLAY "Error INTERVAL 0"
	  LET exitStatus = 1
	END IF

	LET lv_iv_onedd = INTERVAL(9) DAY(1) TO DAY
	IF lv_iv_onedd != INTERVAL(9) DAY(1) TO DAY THEN
		DISPLAY "Error INTERVAL 9"
	  LET exitStatus = 1
	END IF

	LET lv_iv_ninedd = INTERVAL(000000000) DAY(9) TO DAY
	IF lv_iv_ninedd != INTERVAL(000000000) DAY(9) TO DAY THEN
		DISPLAY "Error INTERVAL 000000000"
	  LET exitStatus = 1
	END IF

	LET lv_iv_ninedd = INTERVAL(999999999) DAY(9) TO DAY
