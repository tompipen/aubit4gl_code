...
display "This test may well work on later versions of an Informix database..."
...
unload to "unl1"
	select * from a LEFT JOIN o ON a.a1 = o.o1 ;

-- select * FROM a, OUTER o, OUTER e WHERE a.a1 = o.o1 AND a.a1 = e.e1;
-- ANSI SQL for the above LEFT Join a to o AND a to e
unload to "unl2"
	select * from a LEFT JOIN o ON a.a1 = o.o1 LEFT JOIN e ON a.a1 = e.e1;

-- select * FROM a, OUTER (o, OUTER e) WHERE a.a1 = o.o1 AND o.a1 = e.e1;
-- ANSI SQL for the above LEFT JOIN a to (LEFT JOIN of e and e (no rows))
unload to "unl3"
	select * from a LEFT JOIN (o LEFT JOIN e ON o.o1 = e.e1) ON a.a1 = o.o1;
end main
