...
MAIN
  DEFINE exitStatus SMALLINT
	...
	DEFINE lv_smallfloat FLOAT

  LET exitStatus = 0

	INITIALIZE lv_int TO NULL
	LET lv_smallfloat = lv_int
	IF lv_smallfloat IS NOT NULL THEN
	   DISPLAY "The conversion from null integer to smallfloat was not null"
		 LET exitStatus = 1
	END IF

	LET lv_int = 123446
	LET lv_smallfloat = lv_int
	IF lv_smallfloat != 123446 OR lv_int IS NULL THEN
	...
	LET lv_smallfloat = lv_int
	IF lv_smallfloat != 2000000000 OR lv_int IS NULL THEN
