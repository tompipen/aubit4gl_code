...
define i smallint
  ...
  start report rscr_extconta to "out"
  ...
  for i = 1 to 25
    ...
    let rec.value = 10+i
    let rec.desc = "desc"
    output to report rscr_extconta(rec.*)
  end for

  finish report rscr_extconta
end main

report rscr_extconta(rec)
define rec record
  account char(15),
  date date,
  cod integer,
...
format
   ...
   before group of rec.account
      skip to top of page
      print column  1,"Date: ",
            column 66,"Pag.: ",pageno using "###"
      print column  1,"----",
            column 66,"----"
      skip 2 lines
      print column  1, "Account: ", rec.account clipped,
            column 58,"BETWEEN:"
      print column 58,"2000/01/01 e 2010/05/31"
      print column  1, "------------------------------------------------------",
                       "-----------------------------------------------------"
      print column  1, " Date",
            column  7, "Cod",
