...
/**
 * Sended by the 4gl program (acting as a server) to inform the client that it is 
 * waiting for something from some context.
 * The context is the number of the command that should originate an answer,
 * 
 * 
 * @author Sérgio Ferreira
 */
public class WaitForEvent implements ClientUICommand {
	private int context;
	...
	public String toString() {
		return "WaitForEvent[context=" + context + "]";
	}
