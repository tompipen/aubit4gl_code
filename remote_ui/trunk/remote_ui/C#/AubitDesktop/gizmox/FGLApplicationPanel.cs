        ...
        public void AddToolBarKey(string Key, string Text, string ID)
        {
            ...
            switch (b.ID)
            {
                case "ACCEPT":
                    ...
                    break;
                case "INTERRUPT":
                     b.Image = "Icons.cancel.png";
                    b.Text = "Cancel";
                    break;

                case "UP":
                     b.Image = "Icons.arrup.png";
                    b.Text = "Up";
                    break;

                case "DOWN":
                     b.Image = "Icons.arrdown.png";
                    b.Text = "Down";
                    break;

                case "PGUP":
                     b.Image = "Icons.arrpgup.png";
                    b.Text = "PageUp";
                    break;

                case "PGDN":
                     b.Image = "Icons.arrpgdown.png";
                    b.Text = "PageDown";
                    break;

                case "INSERT":
                     b.Image = "Icons.insert.png";
                    b.Text = "Insert";
                    break;

                case "DELETE":
                     b.Image = "Icons.delete.png";
                    b.Text = "Delete";
                    break;
            }
            b.Visible = false;
            ...
            if (tsBtnPgDown == null && hasActionInToolbar("PGDN"))
            {
                ...
                if (tsBtnAccept==null)
                {
                    ...
                    this.tsBtnAccept.ID = "ACCEPT";
                     this.tsBtnAccept.Image = "Icons.accept.png";
                ...
                if (tsBtnCancel==null)
                {
                    ...
                    this.tsBtnCancel.ID = "INTERRUPT";
                     this.tsBtnCancel.Image = "Icons.cancel.png";
                ...
                if (tsBtnUp == null)
                {
                    ...
                    this.tsBtnUp.alwaysShow = AubitDesktop.showMode.ShowAlways;
                     this.tsBtnUp.Image = "Icons.arrup.png";
                ...
                if (tsBtnDown == null)
                {
                    ...
                    this.tsBtnDown.ID = "DOWN";
                     this.tsBtnDown.Image = "Icons.arrdown.png";
                ...
                if (tsBtnPgDown == null)
                {
                    ...
                    this.tsBtnPgDown.ID = "PGDN";
                     this.tsBtnPgDown.Image = "Icons.arrpgdown.png";
                ...
                if (tsBtnPgUp == null)
                {
                    ...
                    this.tsBtnPgUp.ID = "PGUP";
                     this.tsBtnPgUp.Image = "Icons.arrpgup.png";
                ...
                if (tsBtnInsert == null)
                {
                    ...
                    this.tsBtnInsert.ID = "Insert";
                     this.tsBtnInsert.Image = "Icons.insert.png";
                ...
                if (tsBtnDelete == null)
                {
                    ...
                    this.tsBtnDelete.ID = "Delete";
                     this.tsBtnDelete.Image ="Icons.delete.png";
