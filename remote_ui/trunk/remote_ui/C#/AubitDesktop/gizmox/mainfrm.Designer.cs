namespace AubitDesktop
{
    partial class mainfrm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.connectionsToolStripMenuItem = new Gizmox.WebGUI.Forms.ToolStripMenuItem();
            this.enableListeningModeToolStripMenuItem = new Gizmox.WebGUI.Forms.ToolStripMenuItem();
            this.tabControl1 = new Gizmox.WebGUI.Forms.TabControl();
            this.tpShortcuts = new Gizmox.WebGUI.Forms.TabPage();
            this.lstShortcuts = new Gizmox.WebGUI.Forms.ListBox();
            this.groupBox2 = new Gizmox.WebGUI.Forms.GroupBox();
            this.btnDuplicate = new Gizmox.WebGUI.Forms.Button();
            this.pictureBox1 = new Gizmox.WebGUI.Forms.PictureBoxCompat();
            this.btnShortcutExecute = new Gizmox.WebGUI.Forms.Button();
            this.btnShortcutEdit = new Gizmox.WebGUI.Forms.Button();
            this.btnShortcutRemove = new Gizmox.WebGUI.Forms.Button();
            this.btnShortcutAdd = new Gizmox.WebGUI.Forms.Button();
            this.tpOptions = new Gizmox.WebGUI.Forms.TabPage();
            this.txtDefaultEncoding = new Gizmox.WebGUI.Forms.TextBox();
            this.label4 = new Gizmox.WebGUI.Forms.Label();
            this.lblPortWarn = new Gizmox.WebGUI.Forms.Label();
            this.txtPort = new Gizmox.WebGUI.Forms.TextBox();
            this.label5 = new Gizmox.WebGUI.Forms.Label();
            this.nbXScale = new Gizmox.WebGUI.Forms.NumericUpDown();
            this.nbYScale = new Gizmox.WebGUI.Forms.NumericUpDown();
            this.label3 = new Gizmox.WebGUI.Forms.Label();
            this.label2 = new Gizmox.WebGUI.Forms.Label();
            this.lblKeyCode = new Gizmox.WebGUI.Forms.Label();
            this.label1 = new Gizmox.WebGUI.Forms.Label();
            this.tbInterruptKey = new Gizmox.WebGUI.Forms.TextBox();
            this.cbReceiveFile = new Gizmox.WebGUI.Forms.CheckBox();
            this.cbSendFile = new Gizmox.WebGUI.Forms.CheckBox();
            this.cbAllowExec = new Gizmox.WebGUI.Forms.CheckBox();
            this.lstIPAddress = new Gizmox.WebGUI.Forms.ListBox();
            this.tpConnections = new Gizmox.WebGUI.Forms.TabPage();
            this.lstConnections = new Gizmox.WebGUI.Forms.DataGridView();
            this.grName = new Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn();
            this.grId = new Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn();
            this.grDate = new Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn();
            this.Direction = new Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn();
            ...
            // 
            this.connectionsToolStripMenuItem.MenuItems.AddRange(new Gizmox.WebGUI.Forms.MenuItem[] {
            ...
            this.tpShortcuts.Padding = new Gizmox.WebGUI.Forms.Padding(3);
            ...
            this.pictureBox1.SizeMode = Gizmox.WebGUI.Forms.PictureBoxCompatSizeMode.StretchImage;
            ...
            this.tpOptions.Padding = new Gizmox.WebGUI.Forms.Padding(3);
            ...
            // lblPortWarn
            // 
            this.lblPortWarn.BorderStyle = Gizmox.WebGUI.Forms.BorderStyle.Fixed3D;
            ...
            // lblKeyCode
            // 
            this.lblKeyCode.BorderStyle = Gizmox.WebGUI.Forms.BorderStyle.Fixed3D;
            ...
            this.lstConnections.ColumnHeadersHeightSizeMode = Gizmox.WebGUI.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            this.lstConnections.Columns.AddRange(new Gizmox.WebGUI.Forms.DataGridViewColumn[] {
            this.grName,
            this.grId,
            this.grDate,
            this.Direction});
            this.lstConnections.Dock = Gizmox.WebGUI.Forms.DockStyle.Fill;
            this.lstConnections.EditMode = Gizmox.WebGUI.Forms.DataGridViewEditMode.EditProgrammatically;
        ...
        private Gizmox.WebGUI.Forms.ToolStripMenuItem connectionsToolStripMenuItem;
        private Gizmox.WebGUI.Forms.ToolStripMenuItem enableListeningModeToolStripMenuItem;
        private Gizmox.WebGUI.Forms.TabControl tabControl1;
        private Gizmox.WebGUI.Forms.TabPage tpShortcuts;
        private Gizmox.WebGUI.Forms.TabPage tpOptions;
        private Gizmox.WebGUI.Forms.TabPage tpConnections;
        private Gizmox.WebGUI.Forms.ListBox lstShortcuts;
        private Gizmox.WebGUI.Forms.GroupBox groupBox2;
        private Gizmox.WebGUI.Forms.Button btnShortcutExecute;
        private Gizmox.WebGUI.Forms.Button btnShortcutEdit;
        private Gizmox.WebGUI.Forms.Button btnShortcutRemove;
        private Gizmox.WebGUI.Forms.Button btnShortcutAdd;
        private Gizmox.WebGUI.Forms.DataGridView lstConnections;
        private Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn grName;
        private Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn grId;
        private Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn grDate;
        private Gizmox.WebGUI.Forms.DataGridViewTextBoxColumn Direction;
        private Gizmox.WebGUI.Forms.Timer timer1;
        private Gizmox.WebGUI.Forms.ListBox lstIPAddress;
        private Gizmox.WebGUI.Forms.PictureBoxCompat pictureBox1;
        private Gizmox.WebGUI.Forms.Label label1;
        private Gizmox.WebGUI.Forms.TextBox tbInterruptKey;
        private Gizmox.WebGUI.Forms.CheckBox cbReceiveFile;
        private Gizmox.WebGUI.Forms.CheckBox cbSendFile;
        private Gizmox.WebGUI.Forms.CheckBox cbAllowExec;
        private Gizmox.WebGUI.Forms.Label lblKeyCode;
        private Gizmox.WebGUI.Forms.Button btnDuplicate;
        private Gizmox.WebGUI.Forms.Label label3;
        private Gizmox.WebGUI.Forms.Label label2;
        private Gizmox.WebGUI.Forms.NumericUpDown nbXScale;
        private Gizmox.WebGUI.Forms.NumericUpDown nbYScale;
        private Gizmox.WebGUI.Forms.TextBox txtPort;
        private Gizmox.WebGUI.Forms.Label label5;
        private Gizmox.WebGUI.Forms.Label lblPortWarn;
        private Gizmox.WebGUI.Forms.TextBox txtDefaultEncoding;
