-- @(#)$Id: rcsmunge.4gl,v 1.2 2002-06-14 09:23:16 afalout Exp $
...
MAIN
	DEFINE s VARCHAR(80)
	LET s = "Version $Revision: 1.2 $ ($Date: 2002-06-14 09:23:16 $)"
	DISPLAY "<<", s, ">>"
	LET s = rcs_munge(s)
	DISPLAY "<<", s, ">>"
END MAIN
...
FUNCTION rcs_munge(in_str)
	...
	LET rcs = "@(#)$Id: rcsmunge.4gl,v 1.2 2002-06-14 09:23:16 afalout Exp $"
