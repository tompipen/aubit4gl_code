...
{
  if (_done_init_module_variables == 0)
    return;
...
int
aclfgl_set_window_title (int nargs)
{				/* Funtion Start */
...
int
aclfgl_get_window_title (int nargs)
{				/* Funtion Start */
...
int
aclfgl_set_window_icon (int nargs)
{				/* Funtion Start */
...
int
aclfgl_set_frame_style (int nargs)
{				/* Funtion Start */
...
int
aclfgl_set_window_type (int nargs)
{				/* Funtion Start */
...
int
aclfgl_set_prompt_style (int nargs)
{				/* Funtion Start */
...
{				/* Funtion Start */
  ...
  pop_params (fbind, 3);
  {
    ...
    gtk_signal_connect (GTK_OBJECT (b), "clicked",
			GTK_SIGNAL_FUNC (store_filename), 0);
  ...
  if (aclfgli_get_err_flg ()
      && (a4gl_sqlca.sqlcode != 0 || a4gl_status != 0 || 0))
    {
      /* SQLERROR */
      if (a4gl_sqlca.sqlcode < 0 && a4gl_status == a4gl_sqlca.sqlcode)
	chk_err (257, _module_name);
      /* ERROR */
      if (a4gl_status < 0)
	chk_err (257, _module_name);
    }
...
{				/* Funtion Start */
  ...
  init_module_variables ();
  pop_params (fbind, 0);
  CHK_UI gtk_widget_hide (win_screen);
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
}				/* END OF FUNCTION */
...
{				/* Funtion Start */
  ...
  init_module_variables ();
  pop_params (fbind, 0);
  CHK_UI gtk_widget_show (win_screen);
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
}				/* END OF FUNCTION */
...
int
aclfgl_entry_max_chars_set (int nargs)
{				/* Funtion Start */
  ...
  init_module_variables ();
  pop_params (fbind, 2);
  CHK_UI gtk_entry_set_max_length (GTK_ENTRY (g), l);
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
}				/* END OF FUNCTION */
...
int
aclfgl_entry_selected_cut (int nargs)
{				/* Funtion Start */
  ...
  pop_params (fbind, 1);
  {
    CHK_UI gtk_editable_cut_clipboard (GTK_EDITABLE (g));
  }
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
...
int
aclfgl_entry_selected_copy (int nargs)
{				/* Funtion Start */
  ...
  pop_params (fbind, 1);
  {
    CHK_UI gtk_editable_copy_clipboard (GTK_EDITABLE (g));
  }
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
...
int
aclfgl_entry_selected_paste (int nargs)
{				/* Funtion Start */
  ...
  pop_params (fbind, 1);
  {
    CHK_UI gtk_editable_paste_clipboard (GTK_EDITABLE (g));
  }
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
...
int
aclfgl_entry_selection_set (int nargs)
{				/* Funtion Start */
  ...
  pop_params (fbind, 3);
  {
    CHK_UI gtk_editable_select_region (GTK_EDITABLE (g), (gint) s, (gint) e);
  }
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
...
int
aclfgl_entry_text_get (int nargs)
{				/* Funtion Start */
...
{				/* Funtion Start */
  ...
  init_module_variables ();
  pop_params (fbind, 1);
  CHK_UI gtk_widget_show ((GtkWidget *) g);
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
}				/* END OF FUNCTION */
...
int
aclfgl_form_caption_get (int nargs)
{				/* Funtion Start */
...
{				/* Funtion Start */
  ...
  init_module_variables ();
  pop_params (fbind, 0);
  CHK_UI gtk_widget_hide (GTK_WIDGET (get_curr_win_gtk ()));
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
}				/* END OF FUNCTION */
...
{				/* Funtion Start */
  ...
  init_module_variables ();
  pop_params (fbind, 0);
  CHK_UI gtk_widget_show (GTK_WIDGET (get_curr_win_gtk ()));
  /* End of code */
  A4GLSTK_popFunction ();
  return 0;
}				/* END OF FUNCTION */
...
{				/* Funtion Start */
  ...
  CHK_UI
    ...
    if ((int) find_param ((char *) WINCODE))
    push_int (1);
  else
    push_int (0);
  return 1;
...
int
aclfgl_list_count_get (int nargs)
{				/* Funtion Start */
...
int
aclfgl_list_current_get (int nargs)
{				/* Funtion Start */
...
int
aclfgl_list_selected (int nargs)
{				/* Funtion Start */
...
int
aclfgl_splat_with_image (int nargs)
{				/* Funtion Start */
