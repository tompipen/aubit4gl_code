...
# +----------------------------------------------------------------------+
#
# $Id: console.c,v 1.28 2006-07-12 14:57:06 mikeaubury Exp $
#*/
...
char *UILIB_A4GL_ui_fgl_winquestion(char *title,char *text,char *def,char *pos,char *icon,int danger) NOPE0
