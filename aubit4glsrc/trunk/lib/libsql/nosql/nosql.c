...
# +----------------------------------------------------------------------+
#
# $Id: nosql.c,v 1.51 2009-12-16 14:43:15 mikeaubury Exp $
#*/
...
int A4GLSQLLIB_A4GLSQL_fetch_cursor_internal(char* cursor_name,int fetch_mode,int fetch_when,int nibind,void* ibind) NOPE0
...
int A4GLSQLLIB_A4GLSQL_open_cursor_internal(char* s,int no,void* vibind) NOPE0
...
void A4GLSQLLIB_A4GLSQL_flush_cursor_internal(char* cursor) NOPE
...
int A4GLSQLLIB_A4GLSQL_cancel (void) {
return 1;
}
