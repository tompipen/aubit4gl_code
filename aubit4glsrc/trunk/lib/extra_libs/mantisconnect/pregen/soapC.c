...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.16 2014-01-16 15:02:36 GMT")
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__IssueHeaderData(struct soap *soap, const char *tag, int id, const struct ns1__IssueHeaderData *a, const char *type)
{
	...
	{	if (soap_out_xsd__integer(soap, "id", -1, &a->id, ""))
		...
		return soap->error;
	if (a->view_USCOREstate)
	{	if (soap_out_xsd__integer(soap, "view_state", -1, &a->view_USCOREstate, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "view_state"))
		return soap->error;
	...
	else if (soap_element_nil(soap, "project"))
		return soap->error;
	if (a->category)
	{	if (soap_out_string(soap, "category", -1, &a->category, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "category"))
		return soap->error;
	if (a->priority)
	{	if (soap_out_xsd__integer(soap, "priority", -1, &a->priority, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "priority"))
		return soap->error;
	if (a->severity)
	{	if (soap_out_xsd__integer(soap, "severity", -1, &a->severity, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "severity"))
		return soap->error;
	if (a->status)
	...
	else if (soap_element_nil(soap, "reporter"))
		return soap->error;
	if (a->summary)
	{	if (soap_out_string(soap, "summary", -1, &a->summary, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "summary"))
		return soap->error;
	if (a->handler)
	{	if (soap_out_xsd__integer(soap, "handler", -1, &a->handler, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "handler"))
		return soap->error;
	if (a->resolution)
	{	if (soap_out_xsd__integer(soap, "resolution", -1, &a->resolution, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "resolution"))
		return soap->error;
	if (a->attachments_USCOREcount)
	{	if (soap_out_xsd__integer(soap, "attachments_count", -1, &a->attachments_USCOREcount, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "attachments_count"))
		return soap->error;
	if (a->notes_USCOREcount)
	{	if (soap_out_xsd__integer(soap, "notes_count", -1, &a->notes_USCOREcount, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "notes_count"))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
