...
# +----------------------------------------------------------------------+
#
# $Id: builtin_d.c,v 1.2 2002-04-24 07:45:59 afalout Exp $
#
*/
...
static void func_trunc(void)  {
	exitwith("trunc not implemented\n");
}

static void func_round(void)  {
	exitwith("round not implemented\n");
}

static void func_exp(void)  {
	exitwith("exp not implemented\n");
}

static void func_logn(void)  {
	exitwith("logn not implemented\n");
}

static void func_log10(void)  {
	exitwith("log not implemented\n");
}

static void func_length(void)  {
...
d=pop_long();
#ifdef DEBUG
/* {DEBUG} */ {debug("Date using...%ld (%s)",d,fmt);
}
#endif
trim(fmt);
...
#ifdef DEBUG
/* {DEBUG} */ {debug("Pushing variable %p dtype %d   %d",ptr,dtype&DTYPE_MASK,dtype);
}
#endif
