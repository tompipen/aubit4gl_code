...
This spec file appears to be obsolete, if for no other reason then because
of the need of some functions to call "internal_xyz" functionsis instead "xyz"
directly (because of prototype clash caused by variable number of arguments).
