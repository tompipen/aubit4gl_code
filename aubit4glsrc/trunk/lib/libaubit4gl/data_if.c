...
# +----------------------------------------------------------------------+
#
# $Id: data_if.c,v 1.2 2002-04-24 07:45:59 afalout Exp $
#
*/
...
void *get_set_s_screenio(void *ptr,int mode,char *name,long var) {
...
void *get_set_s_inp_arr(void *ptr,int mode,char *name,long var) {
...
void *get_set_s_prompt(void *ptr,int mode,char *name,long var) {
struct s_s_prompt_1 {
void * win;
int  mode;
int  charmode;
...
void *get_set_s_disp_arr(void *ptr,int mode,char *name,long var) {
