...
static void A4GL_null_reference(void *p) {
...
static int A4GL_isnull_reference(void *p) {
	int isnull;
...
static void A4GL_zero_reference(void *p) {
        struct s_pass_reference *ptr;
...
static char *A4GL_display_reference (void *vptr, int size, int size_c,
...
static void *A4GL_conv_reference(void *p) {
printf("conv_ref1\n");
return NULL;
}
