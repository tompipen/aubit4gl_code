...
/*	 register long *buf; */
	...
	case 11:
	case 12:
		 if (!xdr_bytes(xdrs, (char **)&objp->single_dtype_u.blobdata.blobdata_val, (u_int *)&objp->single_dtype_u.blobdata.blobdata_len, ~0)) {
			 return (FALSE);
		 }
		break;
	default:
...
/*	 register long *buf; */
	 ...
	 if (!xdr_array(xdrs, (char **)&objp->parameters.parameters_val, (u_int *)&objp->parameters.parameters_len, ~0, sizeof(object_data), (xdrproc_t)xdr_object_data)) {
		 return (FALSE);
	 }
	 if (!xdr_array(xdrs, (char **)&objp->sizedata.sizedata_val, (u_int *)&objp->sizedata.sizedata_len, ~0, sizeof(long), (xdrproc_t)xdr_long)) {
		 return (FALSE);
	 }
	return (TRUE);
}
