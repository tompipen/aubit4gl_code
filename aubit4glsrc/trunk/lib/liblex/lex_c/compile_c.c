...
# +----------------------------------------------------------------------+
#
# $Id: compile_c.c,v 1.58 2003-02-19 08:46:39 mikeaubury Exp $
...
/**
 * Print the C implementation for the CLOSE statement.
 *
 * @param type The thing to be closed:
 *  - F : Form. 
 *  - W : Window.
 *  - D : Database.
 *  - S : Session.
 *  - C : Cursor.
 * @param name The name of the object to be closed.
 */
void
...
/**
 * The parser found the SET SESSION TO statement.
 * This instruction is an extension to informix 4gl.
 *
...
/**
 * Print to the generated output C file the call to the library
 * commit_rollback() function that implements the commit or rollback
 * of a transaction.
 *
 * Called by the parser when founds a COMMIT or ROLLBACK 4gl statement.
 *
 * @param t The instruction that was called in 4gl:
 *   - -1 : Begin work
 *   - 0 : Rollback work
 *   - 1 : Commit work
 */
