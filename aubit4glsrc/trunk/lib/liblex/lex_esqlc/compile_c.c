...
# +----------------------------------------------------------------------+
#
# $Id: compile_c.c,v 1.497 2009-07-03 05:54:55 mikeaubury Exp $
# @TODO - Remove rep_cond & rep_cond_expr from everywhere and replace
# with struct expr_str equivalent
*/
#ifndef lint
static char const module_id[] = "$Id: compile_c.c,v 1.497 2009-07-03 05:54:55 mikeaubury Exp $";
#endif
/**
 * @file
  ...
  if (v->arr_subscripts.arr_subscripts_len)
	...
	{			// Dynamic array
	  ...
	  switch (nv->var_data.variable_type)
		...
		{
		  printc ("struct _dynelem_%s { %s dummyname;};", name,
			  local_rettype_integer (nv->var_data.variable_data_u.v_simple.datatype));
