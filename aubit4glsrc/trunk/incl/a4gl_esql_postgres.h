...
#define COPY_DATA_IN_5(a4gl,infx,size) exitwith("NIY - I5")

#define COPY_DATA_IN_6(a4gl,infx,size) *(infx)=*(a4gl)
#define COPY_DATA_IN_7(a4gl,infx,size) *(infx)=*(a4gl)
#define COPY_DATA_IN_8(a4gl,infx,size) exitwith("NIY - I8")

#define COPY_DATA_IN_9(a4gl,infx,size) *(infx)=*(a4gl)
#define COPY_DATA_IN_10(a4gl,infx,size) exitwith("NIY - I10")
#define COPY_DATA_IN_11(a4gl,infx,size) exitwith("NIY - I11")
#define COPY_DATA_IN_12(a4gl,infx,size) exitwith("NIY - I12")
#define COPY_DATA_IN_13(a4gl,infx,size) strcpy(*(infx),*(a4gl))
#define COPY_DATA_IN_14(a4gl,infx,size) exitwith("NIY - I14")
