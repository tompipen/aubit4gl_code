...
# +----------------------------------------------------------------------+
#
# $Id: a4gl_libaubit4gl.h,v 1.427 2012-07-25 09:57:08 mikeaubury Exp $
#
*/
...
void A4GL_register_module_objects(char *modulename,  void **objData) ;
  ...
  void A4GLSTK_popFunction_nl (int nrets,int lineno);
...
#define LOCATE_VAR_DEFINED
  ...
  void A4GL_whats_in_a_string(char *s,int *d,int *sz,int dtype_hint);
...
int A4GL_sqlid_from_aclfile(char *dbname,char *uname,char *passwd,char *dsn);
...
int A4GL_removePreparedStatementBySid(void *sid);
