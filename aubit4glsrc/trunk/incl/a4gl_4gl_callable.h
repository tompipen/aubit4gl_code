...
# +----------------------------------------------------------------------+
#
# $Id: a4gl_4gl_callable.h,v 1.21 2006-06-23 14:08:43 mikeaubury Exp $
*/
...
struct s_sid * A4GLSQL_prepare_select (struct BINDING *ibind, int ni, struct BINDING *obind, int no, char *s,char *modname, int lineno);
