...
# +----------------------------------------------------------------------+
#
# $Id: a4gl_incl_4glhdr.h,v 1.22 2003-05-20 20:17:22 mikeaubury Exp $
*/
...
#define BEFORE_DELETE  (_fld_dr==-12)
#define AFTER_DELETE  (_fld_dr==-13)
#define BEFORE_INSERT  (_fld_dr==-14)
#define AFTER_INSERT  (_fld_dr==-15)
