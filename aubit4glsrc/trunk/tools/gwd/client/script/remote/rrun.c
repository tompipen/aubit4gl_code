...
*/
   ...
   // from the filename and takeout.ini determine default filename and location
   {
      ...
      GetPrivateProfileString("Remote", "LastTakeOutFileName", "", g_szFileName, sizeof(g_szFileName), "gte.ini");
      if(szDocFileName)
...
//   {
       ...
       GetPrivateProfileString("Remote", "LastSysRun", "", g_szSysName, sizeof(g_szSysName), "gte.ini");
      ...
      WritePrivateProfileString("Remote", "LastSysRun", g_szSysName, "gte.ini");
...
//   strcpy(szProject, "job_post");
   GetPrivateProfileString("Project", "1", "", szProject, sizeof(szProject), szProjectTOC);
   ...
   GetPrivateProfileString("Project", "Runner", "", szRunner, sizeof(szRunner), szProgramTOC);
   ...
   strcpy(szWindowSize, "100X30");
      ...
      strcpy (szCmdLine,szRunner); strcat (szCmdLine," ");
