...
xdr_expr (XDR *xdrs, expr *objp)
{
	...
	case EXPRTYPE_COMPLEX:
		 if (!xdr_pointer (xdrs, (char **)&objp->expr_u.expr, sizeof (struct complex_expr), (xdrproc_t) xdr_complex_expr))
			 return FALSE;
		break;
	case EXPRTYPE_COMPARE:
		 if (!xdr_pointer (xdrs, (char **)&objp->expr_u.cexpr, sizeof (struct compare_expr), (xdrproc_t) xdr_compare_expr))
			 return FALSE;
		break;
	case EXPRTYPE_SIMPLE:
		 if (!xdr_pointer (xdrs, (char **)&objp->expr_u.sexpr, sizeof (struct simple_expr), (xdrproc_t) xdr_simple_expr))
			 return FALSE;
		break;
	case EXPRTYPE_LIST:
		 if (!xdr_pointer (xdrs, (char **)&objp->expr_u.lexpr, sizeof (struct expr_list), (xdrproc_t) xdr_expr_list))
			 return FALSE;
		break;
	case EXPRTYPE_FCALL:
		 if (!xdr_pointer (xdrs, (char **)&objp->expr_u.fcall, sizeof (struct expr_call), (xdrproc_t) xdr_expr_call))
			 return FALSE;
		break;
	case EXPRTYPE_AGG:
...
xdr_expr_list (XDR *xdrs, expr_list *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_array (xdrs, (char **)&objp->elem.elem_val, (u_int *) &objp->elem.elem_len, ~0,
		sizeof (expr), (xdrproc_t) xdr_expr))
		 return FALSE;
	return TRUE;
}
...
xdr_expr_call (XDR *xdrs, expr_call *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_string (xdrs, &objp->fname, ~0))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->lexpr, sizeof (expr_list), (xdrproc_t) xdr_expr_list))
		 return FALSE;
	return TRUE;
}
...
xdr_ascii (XDR *xdrs, ascii *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_array (xdrs, (char **)&objp->variables.variables_val, (u_int *) &objp->variables.variables_len, ~0,
		sizeof (variable), (xdrproc_t) xdr_variable))
		 return FALSE;
	return TRUE;
}
...
xdr_select_stmts (XDR *xdrs, select_stmts *objp)
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		...
		IXDR_PUT_LONG(buf, objp->wherepos2);
		 ...
		 if (!xdr_array (xdrs, (char **)&objp->varids.varids_val, (u_int *) &objp->varids.varids_len, ~0,
			sizeof (int), (xdrproc_t) xdr_int))
			 return FALSE;
		 if (!xdr_array (xdrs, (char **)&objp->varpos.varpos_val, (u_int *) &objp->varpos.varpos_len, ~0,
			sizeof (int), (xdrproc_t) xdr_int))
			 return FALSE;
		 if (!xdr_string (xdrs, &objp->temp_tab_name, ~0))
			 return FALSE;
		 if (!xdr_array (xdrs, (char **)&objp->orderby_list.orderby_list_val, (u_int *) &objp->orderby_list.orderby_list_len, ~0,
			sizeof (int), (xdrproc_t) xdr_int))
			 return FALSE;
		return TRUE;
	} else if (xdrs->x_op == XDR_DECODE) {
...
xdr_get_data (XDR *xdrs, get_data *objp)
{
	...
	case 0:
		 if (!xdr_array (xdrs, (char **)&objp->get_data_u.selects.selects_val, (u_int *) &objp->get_data_u.selects.selects_len, ~0,
...
xdr_cmd_for (XDR *xdrs, cmd_for *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_expr (xdrs, &objp->step))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->command, sizeof (struct command), (xdrproc_t) xdr_command))
		 return FALSE;
	return TRUE;
}
...
xdr_cmd_if (XDR *xdrs, cmd_if *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_pointer (xdrs, (char **)&objp->command, sizeof (struct command), (xdrproc_t) xdr_command))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->elsecommand, sizeof (struct command), (xdrproc_t) xdr_command))
		 return FALSE;
	return TRUE;
}
...
xdr_cmd_call (XDR *xdrs, cmd_call *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_pointer (xdrs, (char **)&objp->fcall, sizeof (expr_call), (xdrproc_t) xdr_expr_call))
		 return FALSE;
	return TRUE;
}
...
xdr_commands (XDR *xdrs, commands *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_array (xdrs, (char **)&objp->commands.commands_val, (u_int *) &objp->commands.commands_len, ~0,
		sizeof (struct command), (xdrproc_t) xdr_command))
		 return FALSE;
	return TRUE;
}
...
xdr_agg_val (XDR *xdrs, agg_val *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_bool (xdrs, &objp->isgroup))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->expr, sizeof (expr), (xdrproc_t) xdr_expr))
		 return FALSE;
	 if (!xdr_pointer (xdrs, (char **)&objp->wexpr, sizeof (expr), (xdrproc_t) xdr_expr))
		 return FALSE;
	return TRUE;
}
...
xdr_report (XDR *xdrs, report *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_array (xdrs, (char **)&objp->functions.functions_val, (u_int *) &objp->functions.functions_len, ~0,
		sizeof (function), (xdrproc_t) xdr_function))
		 return FALSE;
	 if (!xdr_array (xdrs, (char **)&objp->variables.variables_val, (u_int *) &objp->variables.variables_len, ~0,
		sizeof (variable), (xdrproc_t) xdr_variable))
		 return FALSE;
	 if (!xdr_array (xdrs, (char **)&objp->inputs.inputs_val, (u_int *) &objp->inputs.inputs_len, ~0,
		sizeof (input_vals), (xdrproc_t) xdr_input_vals))
		 return FALSE;
	 if (!xdr_output (xdrs, &objp->output))
		 return FALSE;
	 if (!xdr_get_data (xdrs, &objp->getdata))
		 return FALSE;
	 if (!xdr_array (xdrs, (char **)&objp->fmt.fmt_val, (u_int *) &objp->fmt.fmt_len, ~0,
		sizeof (format), (xdrproc_t) xdr_format))
		 return FALSE;
	 if (!xdr_array (xdrs, (char **)&objp->aggs.aggs_val, (u_int *) &objp->aggs.aggs_len, ~0,
		sizeof (agg_val), (xdrproc_t) xdr_agg_val))
		 return FALSE;
	return TRUE;
}
