	...
	struct_form_field *objp;
{
	...
	if (!xdr_array(xdrs, (char **)&objp->metric.metric_val, (u_int *)&objp->metric.metric_len, ~0, sizeof(int), xdr_int)) {
		return (FALSE);
	}
	return (TRUE);
}
	...
	struct_scr_field *objp;
{
	...
	if (!xdr_array(xdrs, (char **)&objp->str_attribs.str_attribs_val, (u_int *)&objp->str_attribs.str_attribs_len, ~0, sizeof(struct_field_attr_string), xdr_struct_field_attr_string)) {
		return (FALSE);
	}
	if (!xdr_array(xdrs, (char **)&objp->bool_attribs.bool_attribs_val, (u_int *)&objp->bool_attribs.bool_attribs_len, ~0, sizeof(FIELD_ATTRIBUTES_BOOL), xdr_FIELD_ATTRIBUTES_BOOL)) {
		return (FALSE);
	}
	...
	struct_screen_record *objp;
{
	...
	if (!xdr_array(xdrs, (char **)&objp->attribs.attribs_val, (u_int *)&objp->attribs.attribs_len, ~0, sizeof(int), xdr_int)) {
		return (FALSE);
	}
	return (TRUE);
}
	...
	struct_form *objp;
{
	...
	if (!xdr_array(xdrs, (char **)&objp->snames.snames_val, (u_int *)&objp->snames.snames_len, ~0, sizeof(screen_name), xdr_screen_name)) {
		return (FALSE);
	}
	if (!xdr_array(xdrs, (char **)&objp->attributes.attributes_val, (u_int *)&objp->attributes.attributes_len, ~0, sizeof(struct_scr_field), xdr_struct_scr_field)) {
		return (FALSE);
	}
	if (!xdr_array(xdrs, (char **)&objp->metrics.metrics_val, (u_int *)&objp->metrics.metrics_len, ~0, sizeof(struct_metrics), xdr_struct_metrics)) {
		return (FALSE);
	}
	if (!xdr_array(xdrs, (char **)&objp->fields.fields_val, (u_int *)&objp->fields.fields_len, ~0, sizeof(struct_form_field), xdr_struct_form_field)) {
		return (FALSE);
	}
	if (!xdr_array(xdrs, (char **)&objp->records.records_val, (u_int *)&objp->records.records_len, ~0, sizeof(struct_screen_record), xdr_struct_screen_record)) {
		return (FALSE);
	}
	if (!xdr_array(xdrs, (char **)&objp->tables.tables_val, (u_int *)&objp->tables.tables_len, ~0, sizeof(struct_tables), xdr_struct_tables)) {
		return (FALSE);
	}
