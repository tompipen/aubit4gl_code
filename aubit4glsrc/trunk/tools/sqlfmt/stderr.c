...
#ifndef lint
static const char rcs[] = "@(#)$Id: stderr.c,v 1.1 2002-11-28 06:40:47 afalout Exp $";
#endif	/* lint */
...
const char *err_rcs_string(const char *s2, char *buffer, size_t buflen)
{
	...
	** "$Revision: 1.1 $ ($Date: 2002-11-28 06:40:47 $)"
...
int main(int argc, char **argv)
{
	...
	version("STDERR", "$Revision: 1.1 $ ($Date: 2002-11-28 06:40:47 $)");
	return(0);
}
