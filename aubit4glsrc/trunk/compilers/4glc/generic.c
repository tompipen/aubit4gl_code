...
# +----------------------------------------------------------------------+
#
# $Id: generic.c,v 1.2 2003-05-08 08:17:27 afalout Exp $
#*/
...
struct generic_entry_expression * new_expression(char type,void *expr) {
	...
	i->type=type;
	if (type=='1') { i->data.e1=expr; }
	if (type=='2') { i->data.e2=expr; }
	if (type=='f') { i->data.ef=expr; }
	return i;
}
...
struct generic_entry *new_entry(char type,void *entry) {
	...
	i->type=type;
	if (type=='i') { i->data.ident=entry;}
	if (type=='v') { i->data.variable=entry;}
	if (type=='i') { i->data.literal=entry;}
	if (type=='L') { i->data.list=entry;}
	if (type=='e') { i->data.expr=entry;}
	return i;
