...
//      MsgBox(g_FavNum, MB_OK);
	...
	
	{
		...
		GetPrivateProfileString ("FavoriteRemoteInitDir", g_FavNum,
					 ...
					 "gte.ini");
	      GetPrivateProfileString ("FavoriteRemoteTakeOutLocation",
...
*/ 
	...
	
	{
	    ...
	    WritePrivateProfileString ("TakeOutLocation", szCmdLine,
				      ...
				      "takeout.ini");
	  WritePrivateProfileString ("InitialPath", szCmdLine,
	    ...
	    
	  {
		...
		GetPrivateProfileString ("FavoriteRemoteFiles", szIniEntry,
					  "", szFileNameFav, FILENAME_MAX,
					  "gte.ini");
		if (szFileNameFav[0] == 0)
		  break;
		GetPrivateProfileString ("FavoriteRemoteInitDir",
		  ...
		  WritePrivateProfileString ("FavoriteRemoteFiles",
					      szIniEntry, g_szFileName,
					      "gte.ini");
		WritePrivateProfileString ("FavoriteRemoteInitDir",
					    szIniEntry, g_szServerInitDir,
					    "gte.ini");
		WritePrivateProfileString ("FavoriteRemoteTakeOutLocation",
...
//         Gte_OpenDocument(szFileName);
	  GetPrivateProfileString ("FavoriteRemoteInitDir", szIniEntry, "",
				    szRemoteInitDirFav, MAX_INIT_DIR,
				    "gte.ini");
	GetPrivateProfileString ("FavoriteRemoteTakeOutLocation", szIniEntry,
				  "", szRemoteTakeOutLocationFav,
				  MAX_FILE_LOCATION, "gte.ini");
