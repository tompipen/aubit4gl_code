...
//static void print_define_char (char *vbuff, char *tbuff, char *abuff, int size, int isstatic_extern, int lvl);
static void print_define_char (char *varo, int size, int isstatic_extern, int lvl, int vno, char *defsrc, char *arrvar);

//static void print_define (char *vbuff, char *tbuff, char *abuff, int isstatic_extern, int lvl);
static void
print_define (char *varstring, int isstatic_extern, int lvl, int vno, char *arrvar);

void ensure_dtype (char *module,int line, struct expr_str *e, int dtype, int notnull);
