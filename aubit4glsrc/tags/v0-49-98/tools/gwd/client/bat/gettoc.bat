...
rem Area name           prop_rejJ.gui - Fujitsu
echo 6%6-
rem -----------------------------------------------------
...
rem echo GETTOCCMD is %GETTOCCMD%
rem echo TOCNAME   is %TOCNAME%
rem echo rcp command will be: rcp -b %4.%5:%GETTOCCMD% "%3%8%TOCNAME%"
rem start /w /m rcp -b %4.%5:%GETTOCCMD% "%3%8%TOCNAME%"
rcp -b %4.%5:%GETTOCCMD% "%3%8%TOCNAME%"
rem pause
if errolevel==9 goto :err9
if errolevel==8 goto :err8
if errolevel==7 goto :err7
