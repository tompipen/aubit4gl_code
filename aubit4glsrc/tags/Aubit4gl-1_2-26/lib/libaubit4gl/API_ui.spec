...
A4GL_new_menu_create_with_attr char* title int x int y int mn_type int help_no char* comment char* style char* image char* normal char* highlight -> void*
...
*aclfgl_aclfgl_client_ui_call int n -> int
