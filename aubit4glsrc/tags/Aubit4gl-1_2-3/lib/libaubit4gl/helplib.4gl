...
function myshowhelp(filename, n)
	define filename char(128)
	define n integer
	...
	open window w1 at 1,1 with form "help"
	call openiem(filename, n ) 
...
function mynextpage(l_count, l_msg)
	define l_count integer
	define l_msg char(HELPMAXLEN)
