...
//#######################################################
{
    ...
    
  {
      ...
      
      {
	     ...
	     || stricmp (szFileExt, "42r") == 0
	     || stricmp (szFileExt, "m") == 0
	     || stricmp (szFileExt, "toc") == 0
...
//############################################################
{
  ...
  GetPrivateProfileString ("Remote", "Transport", "", g_szTransport,
      ...
      // from the filename and takeout.ini determine default filename and location
    {
      ...
      GetPrivateProfileString ("InitialPath", szDocFileName,
...
*/ 
	...
	{
	  MsgBox ("Program make NOT successful!",
...
//       strcat(szMakeErr, "\\MakeErr.ini");
	    ...
	    //####################
	  {
	    ...
	    GetPrivateProfileString (szIniEntry, "Path", "", szPath,
				      FILENAME_MAX, szMakeErr);
	    if (szPath[0] == 0)
	      break;
	    GetPrivateProfileString (szIniEntry, "File", "", szFile,
				      FILENAME_MAX, szMakeErr);
	    GetPrivateProfileString (szIniEntry, "Ext", "", szExt,
				      FILENAME_MAX, szMakeErr);
...
//#####################################################################
{
  ...
  
  {
    ...
    GetPrivateProfileString ("Project", "SourcePath", "", szSourcePath,
			     FILENAME_MAX, szTOC);
  GetPrivateProfileString ("Project", "FormsPath", "", szFormsPath,
			    FILENAME_MAX, szTOC);
  GetPrivateProfileString ("Project", "ExecPath", "", szExecPath,
			    FILENAME_MAX, szTOC);
  ...
  
  {
    ...
    int i;
	  ...
	  
	  {
		...
		GetPrivateProfileString (szExt, szIniEntry, "",
	  ...
	  
	  {
		...
		int i;
		...
		GetPrivateProfileString ("4gl", "1", "", szSourceFile,
					   FILENAME_MAX, szTOC);
		  ...
		  
		  {
		    ...
		    GetPrivateProfileString ("4gl", szIniEntry, "",
